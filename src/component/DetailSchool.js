...
export default function SelectDetailSchool() {
    ...
    return (
        ...
        <Header headerText={`${filteredSchool[0]?.name}`} style={{ width:'320px', fontWeight: 'bold'}}/>
            ...
            <p style={{textAlign:'left', fontFamily :'"Pretendard Variable", sans-serif', fontWeight: 'bold',fontSize:'18px'}} >학교 주변 매물</p>
            <div style={{height:'3px'}}></div>
            <p style={{textAlign:'left', fontFamily :'"Pretendard Variable", sans-serif', fontWeight: 'bold',fontSize:'14px'}} >총  {apt.length}건</p>
